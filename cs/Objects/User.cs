...
namespace bygfoot
{
	...
	public class User
	{
		...
		public void SetupTeam(bool removePlayers)
		{
			...
			if (Option.SettingInt("int_opt_disable_transfers") != 0)
			...
			if (Option.SettingInt("int_opt_disable_ya") == 0)
				YouthAcademy = new YouthAcademy(this);

			Counters[(int)CounterValue.COUNT_USER_NEW_SPONSOR] = Option.SettingInt("int_opt_disable_finances") == 1 ? -5 : 1;

			Option.OptionInt("int_opt_user_penalty_shooter", Options, -1);
		}
		...
		public void SetupCounters()
		{
			...
			Counters[(int)CounterValue.COUNT_USER_TRAININGS_LEFT_SEASON] = Option.ConstInt("int_training_camps_per_season");
		}
